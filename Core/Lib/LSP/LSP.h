...
class SyntaxTreeViewParams : public Serializable {
public:
    std::string uri;
...
class SyntaxTreeViewResponse : public Serializable {
public:
    std::vector<SyntaxTreeNodeInfo> data;
